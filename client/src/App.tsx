...
const BLOG_CARDS: BlogCard[] = [
  {
    ...
    imageAlt: "Abstract colourful design shapes on a dark background",
  },
  {
    ...
    imageAlt: "Lines of code on a dark monitor screen",
  },
  {
    category: "Writing",
    ...
    imageAlt: "Open notebook with a pen resting on a wooden desk",
  },
];
    ...
    <section className="relative min-h-screen bg-[#0C0C0C] flex items-center overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 pt-28 pb-20 w-full">
        <div className="max-w-4xl">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-white/[0.06] border border-white/[0.1] rounded-full px-4 py-2 mb-10 backdrop-blur-sm animate-fade-in">
          ...
          {/* Headline */}
          <h1
            className="text-5xl sm:text-6xl md:text-7xl lg:text-[5.5rem] font-bold text-white leading-[1.05] tracking-tight mb-8"
            style={{ fontFamily: "'Playfair Display', serif" }}
          >
            Write with{" "}
            <span className="relative inline-block">
              <span className="relative z-10 text-amber-400">Authority.</span>
              <span className="absolute bottom-1 left-0 right-0 h-[3px] bg-amber-400/30 rounded-full" />
            </span>
            <br />
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <a
              href="#blogs"
              className="inline-flex items-center gap-2 text-white/60 hover:text-white font-medium px-6 py-4 rounded-full border border-white/10 hover:border-white/25 transition-all duration-300 text-base hover:bg-white/[0.04]"
            >
              Explore Blogs
            </a>
          </div>
          ...
          <div className="mt-16 flex flex-col sm:flex-row items-start sm:items-center gap-6 sm:gap-10">
            <div className="flex -space-x-3">
              {["#E8A838", "#5B8DEF", "#3DBDA7", "#E87B5B"].map((color, i) => (
                <div
                  key={i}
        ...
        <div className="hidden lg:block absolute right-0 top-1/2 -translate-y-1/2 w-[340px] mr-[-20px]">
          <div className="bg-white/[0.04] border border-white/[0.1] rounded-2xl p-5 backdrop-blur-md">
          ...
          {/* Second card, offset */}
          <div className="bg-white/[0.03] border border-white/[0.07] rounded-2xl p-4 backdrop-blur-md mt-3 ml-6 opacity-60">
      ...
      {/* Bottom fade */}
      <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-[#F8F6F1] to-transparent pointer-events-none" />
    </section>
  );
}
        ...
        >
          {FEATURES.map((feature, i) => (
            ...
            >
              ...
              <h3
                className="text-[#1A1A1A] font-semibold text-lg mb-2 leading-snug"
                style={{ fontFamily: "'Playfair Display', serif" }}
              >
                {feature.title}
              </h3>
  ...
  return (
    <section className="bg-[#0C0C0C] py-28 px-6 overflow-hidden relative">
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        >
          {/* Connector line */}
          <div className="hidden md:block absolute top-10 left-[calc(16.67%+32px)] right-[calc(16.67%+32px)] h-px bg-gradient-to-r from-amber-400/30 via-amber-400/60 to-amber-400/30" />
          ...
          {STEPS.map((step, i) => (
            ...
            >
              ...
              <div className="mt-6 flex items-center gap-2 text-amber-400 text-xs font-medium">
                ...
                <span>
                  {["Free forever", "24-hour review", "Instant publish"][i]}
                </span>
              </div>
            </div>
          ))}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div ref={ref} className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {BLOG_CARDS.map((card, i) => (
            ...
            >
              {/* Cover image */}
              <div className="relative overflow-hidden h-48 bg-[#F0EDE7] flex-shrink-0">
                <img
                  src={card.image}
                  alt={card.imageAlt}
              ...
              <div className="p-7 flex flex-col flex-1">
                {/* Title */}
                <h3
                  className="text-[#1A1A1A] font-bold text-xl leading-snug mb-3 group-hover:text-amber-700 transition-colors duration-200 flex-1"
                  style={{ fontFamily: "'Playfair Display', serif" }}
                >
                  {card.title}
                </h3>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-[#F0EDE7]">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[#9B9B9B] text-[11px]">{card.role}</p>
                    </div>
                  </div>
          ...
          {TESTIMONIALS.map((t, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 pt-5 border-t border-[#E8E4DC]">
                <div className="w-10 h-10 rounded-full bg-amber-400 flex items-center justify-center text-xs font-bold text-[#0C0C0C] flex-shrink-0">
                  {t.initials}
                </div>
                <div>
                  ...
                  <p className="text-[#9B9B9B] text-xs">{t.role}</p>
                </div>
...
function CTASection() {
  return (
    <section className="bg-[#0C0C0C] py-28 px-6 relative overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] rounded-full bg-amber-500/8 blur-[100px]" />
        <div
      ...
      <div className="max-w-4xl mx-auto text-center relative">
        ...
        {/* Stats row */}
        <div className="mt-20 pt-12 border-t border-white/[0.06] grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
...
export default function LandingPage() {
  // Inject Google Fonts
  useEffect(() => {
    const existing = document.getElementById("inscribe-fonts");
    if (existing) return;
    const link = document.createElement("link");
    link.id = "inscribe-fonts";
    link.rel = "stylesheet";
    link.href =
