...
class PublishArticleRoute implements IRoute {
  path: string;
  router;
  ...
  private initRoute(): void {
    this.router.route(`${this.path}/:id/publish`).patch(
      ...
      (req: Request, res: Response) =>
        Controllers.WriterControllers.PublishArticle.execute(req, res),
    );
  }
}

export default PublishArticleRoute;
